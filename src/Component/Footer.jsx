...
const Footer = () => {
  return (
    <footer className="bg-gray w-screen py-8">
        <div className="flex flex-row justify-center w-11/12 mx-auto space-x-80 gap-16">
            <div className="flex items-center">
                <img src="/src/assets/logo/Logo con scritta piccolo.png"></img>
            </div>
            <div className="flex flex-col items-center ">
                <div className="flex justify-center gap-8 text-white-100 pb-4">
                    <a href="#" className="font-roboto font-medium">Info</a>
                    <a href="#" className="font-roboto font-medium">Profilo</a>
                    <a href="#" className="font-roboto font-medium">Impostazioni</a>
                    <a href="#" className="font-roboto font-medium">Legal</a>
                </div>
                ...
                <div>
                    <p className="flex justify-center text-xs text-white-100 font-montserrat font-thin">Design with love © Claees 2023. All right reserved</p>
                </div>
            </div>
            <div className="flex flex-col justify-center">
                ...
                <p className=" flex justify-center pt-2 text-white-100 font-montserrat font-light">gympro@gmail.com</p>
            </div>
        </div>
    </footer>
  );
