  ...
  return (
    <nav className="flex bg-[#393b44] w-[100%] justify-between ">
      ...
      <div className=" text-white-100 gap-5 flex items-center hover:decoration-solid ">
        <Link className=" hover:border-b hover:text-yellow-100 ">Home</Link>
        <Link className="hover:border-b hover:text-yellow-100">
          Aziende Partner
        </Link>
        <Link className="hover:border-b hover:text-yellow-100">Chi siamo</Link>
        <Link className="hover:border-b hover:text-yellow-100">FAQ</Link>
      </div>
