      ...
      <div className="flex flex-row gap-40">
        <div className="flex flex-col gap-8">
          <div className="border border-solid border-white-100 rounded-xl w-96">
            ...
            <Link className="flex text-white-100 pl-10 underline font-montserrat font-extralight hover:text-yellow-200">
          ...
          <div className="flex flex-row justify-center py-6 border border-solid border-white-100 rounded-xl w-96 gap-2">
            ...
            <Link className="underline font-bold font-montserrat text-white-100 hover:text-yellow-200">
              Registrati
            </Link>
          </div>
        </div>
