        ...
        <div className="bg-white-00 border border-slate-300 rounded-xl w-full mx-auto bg-gray ">
          <table className="w-full ">
            ...
            <tbody className="w-full font-montserrat">
                <tr>
                    ...
                    <td className="pl-24 w-1/5">
                        <input className="rounded-md pl-1" placeholder="Inserisci set"/>
                    </td>
                    <td className="pl-24 w-1/5">
                        <input className="rounded-md pl-1" placeholder="Inserisci ripetizioni"/>
                    </td>
                    ...
                    <td className="pl-24 w-1/5">
                        <input className="rounded-md pl-1" placeholder="Inserisci kg"/>
                    </td>
                </tr>
            </tbody>
          </table>
            ...
            <div className="flex flex-row-reverse w-full">
                <button className="border rounded-lg py-1 px-1 border-slate-300 text-white-100 font-montserrat font-normal bg-gray">Aggiungi esercizio </button>
            </div>
