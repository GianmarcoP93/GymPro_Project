  ...
  return (
    ...
    <img src={logo} alt="" className=" w-[50px] h-[50px]" />
      <div className=" text-white-100 gap-5 flex items-center hover:decoration-solid font-roboto max-sm:gap-2 max-sm:flex">
        <Link className=" hover:border-b hover:text-yellow-200 max-sm:text-sm ">Home</Link>
        <Link className="hover:border-b hover:text-yellow-200 max-sm:text-sm max-sm:text-center">
          Aziende Partner
        </Link>
        <Link className="hover:border-b hover:text-yellow-200 max-sm:text-sm">Chi siamo</Link>
        <Link className="hover:border-b hover:text-yellow-200 max-sm:text-sm">FAQ</Link>
      </div>
