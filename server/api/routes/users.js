...
app.post("/register", async (req, res) => {
  ...
  try {
    ...
    const passNumber = await createPassNumber();
      ...
      attachments: [
        {
          ...
          path: "./htmlImages/weights.png",
          cid: "weight",
        },
        {
          filename: "logoPiccolo.png",
          path: "./htmlImages/logoPiccolo.png",
          cid: "logo",
        },
        {
          filename: "bg-top.png",
          path: "./htmlImages/bg-top.png",
          cid: "bg",
        },
      ],
      html: `<!DOCTYPE html>
    ...
    <tr>
    <td>
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #000; background-image: url('cid:bg'); background-position: top center; background-repeat: repeat; color: #000; width: 640px; margin: 0 auto;" width="640">
    <tbody>
    <tr>
    ...
    <div align="center" class="alignment" style="line-height:10px"><img alt="Your Logo" src="cid:logo" style="display: block; height: auto; border: 0; max-width: 106px; width: 100%;" title="Your Logo" width="106"/></div>
    </td>
    </tr>
    </table>
    ...
    <div align="center" class="alignment" style="line-height:10px"><img alt="Man Lifting Dumbell" class="fullWidth" src="cid:weight" style="display: block; height: auto; border: 0; max-width: 480px; width: 100%;" title="Man Lifting Dumbell" width="480"/></div>
    </td>
    </tr>
    </table>
